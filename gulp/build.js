...
gulp.task('build', function (done) {
  runSeq('clean', ['buildsass', 'buildimg', 'buildjs', 'json'], 'buildhtml', done);
});
...
//Build jsons for distribution.
gulp.task('json', function () {
   gulp.src(global.paths.json + '/model.json')
       .pipe(gulp.dest(global.paths.dist_json))
});
